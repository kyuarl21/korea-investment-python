...
class Operator:
    def start(self):
        ...
        def monitoring_kospi_stocks():
            DomesticMonitoring.monitoring_kospi_stocks(
        ...
        def monitoring_kosdaq_stocks():
            DomesticMonitoring.monitoring_kosdaq_stocks(
        ...
        def monitoring_nasdaq_stocks():
            OverseasMonitoring.monitoring_nasdaq_stocks(
        ...
        def monitoring_new_york_stocks():
            OverseasMonitoring.monitoring_new_york_stocks(
        ...
        def monitoring_amex_stocks():
            OverseasMonitoring.monitoring_amex_stocks(
